...
SRC_BASE_DIR_$(MCU) := \
	...
	$(HAL_FOLDER_$(MCU))/Drivers/STM32F3xx_HAL_Driver/Src
...
CFLAGS_$(MCU) := \
	...
	-I$(HAL_FOLDER_$(MCU))/Drivers/STM32F3xx_HAL_Driver/Inc \
	-I$(HAL_FOLDER_$(MCU))/Drivers/CMSIS/Include \
	-I$(HAL_FOLDER_$(MCU))/Drivers/CMSIS/Device/ST/STM32F3xx/Include
