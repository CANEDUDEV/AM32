...
/* Private defines -----------------------------------------------------------*/
#define TIM1_CH1_Pin LL_GPIO_PIN_0
#define TIM1_CH1_GPIO_Port GPIOC
#define FET_TEMP_Pin LL_GPIO_PIN_2
#define FET_TEMP_GPIO_Port GPIOA
#define CURR_A_Pin LL_GPIO_PIN_6
#define CURR_A_GPIO_Port GPIOA
#define CURR_B_Pin LL_GPIO_PIN_4
#define CURR_B_GPIO_Port GPIOC
#define CURR_C_Pin LL_GPIO_PIN_5
#define CURR_C_GPIO_Port GPIOC
#define GATE_ENABLE_Pin LL_GPIO_PIN_2
#define GATE_ENABLE_GPIO_Port GPIOB
#define NFAULT_Pin LL_GPIO_PIN_10
